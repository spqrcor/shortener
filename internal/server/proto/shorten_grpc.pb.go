...
const (
	URLShortenerService_DeleteURLs_FullMethodName     = "/server.URLShortenerService/DeleteURLs"
	URLShortenerService_GetOriginalURL_FullMethodName = "/server.URLShortenerService/GetOriginalURL"
	URLShortenerService_PingDB_FullMethodName         = "/server.URLShortenerService/PingDB"
	URLShortenerService_Shorten_FullMethodName        = "/server.URLShortenerService/Shorten"
	URLShortenerService_ShortenBatch_FullMethodName   = "/server.URLShortenerService/ShortenBatch"
	URLShortenerService_Stats_FullMethodName          = "/server.URLShortenerService/Stats"
	URLShortenerService_UserURLs_FullMethodName       = "/server.URLShortenerService/UserURLs"
)
